...
class ServerRaumHTTPHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "/data":
            ...
            data = json.dumps('{"room":' + str(ServerRaumHTTPHandler.room) + ', "temp":' + str(
                ServerRaumHTTPHandler.temp) + ', "humid":' + str(ServerRaumHTTPHandler.humid) + ', "tlimit":' + str(
                ServerRaumHTTPHandler.tlimit) + ', "hlimit":' + str(ServerRaumHTTPHandler.hlimit) + '}')
